# 1 "calculator_function/calculator_functions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "calculator_function/calculator_functions.c" 2
...
# 11 "C:\\Program Files\\Microchip\\xc8\\v2.45\\pic\\include\\c99\\math.h" 2 3
...
# 8 "calculator_function/calculator_functions.c" 2
# 17 "calculator_function/calculator_functions.c"
...
*num_value = *num_value + (arr[count] - 48)* (powf(10,count_power));
count_power--;
}
}
